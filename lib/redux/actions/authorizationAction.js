...
function getPermissionForUser() {
  return /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee(dispatch) {
      var IAM_BACKEND_PERMISSION, PROJECT_CODE, token, headers, url, options;
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              IAM_BACKEND_PERMISSION = process.env.FWORK_API_ENDPOINT + "/iam/authorization/" || "https://dev.fpt.work/api/v1/iam/authorization/";
