...
var baseURL = process.env.FWORK_API_ENDPOINT + '/portal' || window.location.origin + '/api/v1/portal';
      ...
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return (0, _fetchAPI["default"])(process.env.FWORK_API_ENDPOINT + '/portal/choose-company' || 'https://dev.fpt.work/api/v1/portal/choose-company', 'POST', params);
