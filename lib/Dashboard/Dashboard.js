...
var _icon_edit = _interopRequireDefault(require("./icons/icon_edit.svg"));

var _icon_back = _interopRequireDefault(require("./icons/icon_back.svg"));

var _icon_forward = _interopRequireDefault(require("./icons/icon_forward.svg"));

var _icon_plus = _interopRequireDefault(require("./icons/icon_plus.svg"));

var _icon_dropdown = _interopRequireDefault(require("./icons/icon_dropdown.svg"));

var _icon_remove = _interopRequireDefault(require("./icons/icon_remove.svg"));

var _icon_screen = _interopRequireDefault(require("./icons/icon_screen.svg"));
...
var Button = _frontendHelper.common.Button,
...
function Dashboard(props) {
  ...
  var _useState3 = (0, _react.useState)(window.innerWidth - 256),
  ...
  var historyRef = (0, _react.useRef)(null);

  var _queryString$parse = _queryString["default"].parse(history.location.search),
  ...
  var addGadget = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee(gadget) {
  ...
  var MenuDropDown = /*#__PURE__*/_react["default"].createElement(_antd.Menu, null, /*#__PURE__*/_react["default"].createElement(_antd.Menu.Item, null, /*#__PURE__*/_react["default"].createElement("a", {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    }, /*#__PURE__*/_react["default"].createElement("span", null, gadget.name), /*#__PURE__*/_react["default"].createElement("span", null, gadget.description)), /*#__PURE__*/_react["default"].createElement(Button, {
      onClick: function onClick() {
  ...
  }, "H\u1EE7y b\u1ECF"), /*#__PURE__*/_react["default"].createElement(Button, {
    onClick: function onClick() {
  ...
  }), " Th\xEAm bi\u1EC3u \u0111\u1ED3"), /*#__PURE__*/_react["default"].createElement(Button, {
    type: "default",
    onClick: handlePrevious
  }, /*#__PURE__*/_react["default"].createElement("img", {
    src: _icon_back["default"]
  })), /*#__PURE__*/_react["default"].createElement(Button, {
    type: "default",
    onClick: handleNext
  }, /*#__PURE__*/_react["default"].createElement("img", {
    src: _icon_forward["default"]
  })), /*#__PURE__*/_react["default"].createElement(Button, {
    onClick: function onClick() {
      return handleSaveLayout(true);
    }
  }, "L\u01B0u v\xE0 s\u1EED d\u1EE5ng"), /*#__PURE__*/_react["default"].createElement(_antd.Dropdown, {
  ...
  }, "Danh s\xE1ch b\u1ED1 c\u1EE5c"), /*#__PURE__*/_react["default"].createElement(Button, {
    onClick: function onClick() {
      return setIsEdit(true);
    }
  }, /*#__PURE__*/_react["default"].createElement("img", {
    src: _icon_edit["default"]
  }), "Ch\u1EC9nh s\u1EEDa b\u1ED1 c\u1EE5c"), /*#__PURE__*/_react["default"].createElement(Button, {
    type: "primary",
    onClick: function onClick() {
      return setDashboardLayout('create-dashboard');
    }
  }, "T\u1EA1o m\u1EDBi"))), !_.isEmpty(dashboard.components) && /*#__PURE__*/_react["default"].createElement(_reactGridLayout["default"], {
    ...
    var gadget = getComponentByCode(component.code);
    return !_.isEmpty(gadget) ? /*#__PURE__*/_react["default"].createElement("div", {
      key: component.i,
      className: "fwork-dashboard-component"
    }, isEdit && /*#__PURE__*/_react["default"].createElement("div", {
      className: "fwork-dashboard-component-action"
    }, /*#__PURE__*/_react["default"].createElement(Button, null, /*#__PURE__*/_react["default"].createElement("img", {
      src: _icon_screen["default"]
    })), /*#__PURE__*/_react["default"].createElement(Button, {
      onClick: function onClick() {
    ...
    }, /*#__PURE__*/_react["default"].createElement(gadget.component, gadget.props))) : /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null);
  })), isEdit && /*#__PURE__*/_react["default"].createElement("div", {
...
function renderGird(width, height) {
  ...
  for (var i = 0; i < 12; i++) {
    // rectangle
    row.push( /*#__PURE__*/_react["default"].createElement("rect", {
  ...
  return /*#__PURE__*/_react["default"].createElement("svg", {
    ...
    width: "1",
    height: (24 + 16) / height
  }, row)), /*#__PURE__*/_react["default"].createElement("rect", {
    fill: "url(#grid)",
    x: "0",
    y: "0",
    width: width - 1,
